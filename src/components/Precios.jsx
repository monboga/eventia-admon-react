  ...
  const packages = [
    {
      ...
      yearlyPrice: 199,
      description:
        "A common form of lorem impsum reads: lorem ipson dolor sit amet",
      green: "/src/assets/green-mark.png",
    },
    {
      name: "Advanced",
      monthlyPrice: 39,
    ...
    <>
      <div className="md:px-14 p-4 max-w-s mx-auto py-10" id="pricing">
        <div className="text-center">
          <h2 className="md:text-5xl text-3xl font-extrabold text-emerald-400 mb-2">
              ...
              <div className="w-14 h-6 bg-gray-300 rounded-full transition duration-200 ease-in-out">
                <div
                  className={`w-6 h-6 rounded-full ${
                    isYearly ? "bg-emerald-900 ml-8" : "bg-gray-500"
                  }`}
                ></div>
              </div>
        ...
        >
          {packages.map((pkg, index) => (
            ...
            >
              <h3 className="text-3xl font-bold text-center text-emerald-900">
                {pkg.name}
              </h3>
              <p className="text-tartiary text-center my-5">
                {pkg.description}
              </p>
              <p className="mt-5 text-center text-emerald-400 text-4xl font-bold">
              ...
              <ul className="mt-4 space-y-2 px-4">
                <li className="flex gap-3 items-center">
                  <img src={pkg.green} alt="" className="w-5" /> Videos of
                  Lessons
                </li>
                <li className="flex gap-3 items-center">
