      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
            ...
            <div className="sm:w-1/2 px-16">
                <h2 className="font-bold text-2xl text-emerald-900">Inicio de sesion</h2>
                <p className="text-sm-mt-4 text-emerald-900">Inicia sesion para ingresar al gestor de eventos</p>

                <form onSubmit={onSubmit} className="flex flex-col gap-4">
                    <input className="p-2 mt-8 rounded-xl border" name="username" value={username} placeholder="Username" onChange={onInputChange}/>
                    <div className="relative">
                        <input className="p-2 rounded-xl border w-full" name="password" type="password" value={password} placeholder="Password" onChange={onInputChange} />
                        <BsEye className="absolute top-1/2 right-3 -translate-y-1/2 text-gray-500"/>
                    </div>
                    <button className="btnPrimary" type="submit">Iniciar Sesion</button>
                </form>
